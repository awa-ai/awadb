...
void TableInfo::SetName(const std::string &name) { name_ = name; }
...
void TableInfo::SetRetrievalType(const std::string &retrieval_type) {
  retrieval_type_ = retrieval_type;
}

std::string &TableInfo::RetrievalParam() { return retrieval_param_; }

void TableInfo::SetRetrievalParam(const std::string &retrieval_param) {
